...
def load_crowdflower(path, max_length=128):
    ...
    print(f"[CrowdFlower] Final dataset shape: {len(dataset)} samples")
...
def split_dataset(dataset, split_ratio=0.8, seed=42):
    ...
    split = int(split_ratio * total_len)
...
if __name__ == "__main__":
    ...
    full_dataset = load_crowdflower('../data/CrowdFlower/text_emotion.csv')
